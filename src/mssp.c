...
void write_to_descriptor_printf( DESCRIPTOR_DATA *d, const char *fmt, ... ) GNUC_FORMAT( 2, 3 );
...
#define codebase "Smaug 1.4a Heavily Modified"
...
void write_to_descriptor_printf( DESCRIPTOR_DATA *d, const char *fmt, ... )
{
